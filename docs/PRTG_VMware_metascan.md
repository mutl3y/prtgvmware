## PRTG_VMware metascan

returns sensors for vmware vcenter instances by name or tag

### Synopsis

used for autodiscovery of vmware sensors

```
PRTG_VMware metascan [flags]
```

### Options

```
  -h, --help   help for metascan
```
